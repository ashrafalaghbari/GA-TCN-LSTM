...
OilDataCleaner (ODC) is a Python module designed for detecting anomalies
in time series data related to the oil industry. With its data cleaning techniques,
ODC is an essential tool for anyone working with oil data. Whether you're a researcher, analyst,
or engineer, ODC can help you identify unusual patterns and outliers in your data,
 enabling you to make more informed decisions.
ODC can clean these types of variables:
on-stream hours for production and injection, production rates, injection rates,
average choke size, reservoir pressure & temperatureand wellhead temperature.
